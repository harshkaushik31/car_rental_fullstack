...
const AddCar = () => {
  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
      <Title title='Add a new car' subTitle='Fill in the details to list a new car for booking, including pricing, availability, and car specifications.'/>
      ...
      <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
        ...
        <div className='flex items-center gap-2 w-full' >
          <label htmlFor="car-image">
            ...
            <input type="file" id='car-image' accept='imgage/*' hidden onChange={e=> setImage(e.target.files[0])} />
          </label>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6' >
          ...
          <div className='flex flex-col w-full'>
            <label>Model</label>
            <input type="text" placeholder='e.g. X5, E-Class, M4 etc...' required 
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6' >
          ...
          <div className='flex flex-col w-full'>
            ...
            <select onChange={e => setCar({...car, category: e.target.value})}  value={car.category} className='px-3 py-2 mt-1 border-borderColor border rounded-md outline-none'>
        ...
        {/* Car Tansmission, Fuel Type and Seating Capacity */}
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
          
          <div className='flex flex-col w-full'>
            <label>Transmittion</label>
            <select onChange={e => setCar({...car, transmission: e.target.value})}  value={car.transmission} className='px-3 py-2 mt-1 border-borderColor border rounded-md outline-none'>
          ...
          <div className='flex flex-col w-full'>
            ...
            <select onChange={e => setCar({...car, fuel_type: e.target.value})}  value={car.fuel_type} className='px-3 py-2 mt-1 border-borderColor border rounded-md outline-none'>
        ...
        <div className='flex flex-col w-full'>
          <label>Location</label>
            <select onChange={e => setCar({...car, location: e.target.value})}  value={car.location} className='px-3 py-2 mt-1 border-borderColor border rounded-md outline-none'>
