  ...
  return (
    ...
    className='flex flex-col md:flex-row md:items-start items-center justify-between px-8 min-md:pl-14 pt-10 bg-gradient-to-r from-[#0558FE] to-[#A9CFFF] max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden'>
        ...
        <div className='text-white'>
            ...
            <p className='mt-2'>Monetize your vehicle effortlessly by listing it on CarRenta1.</p>
            ...
            whileTap={{scale: 0.95}}
            className='px-6 py-2 bg-white hover:bg-state-100 transition-all text-primary rounded-lg text-sm mt-4 cursor-pointer'>
                List Your Car
            </motion.button>
